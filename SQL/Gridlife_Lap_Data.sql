...
--
-- Host: 127.0.0.1    Database: lapdata
-- ------------------------------------------------------
...
--
-- Current Database: `lapdata`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `lapdata` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
INSERT INTO `cars` VALUES (1,'Ford','Pinto','RWD'),(2,'Subaru','Brat','AWD'),(3,'Pontiac','Grand Prix','FWD'),(4,'testcar','testmodel','RWD'),(194,'Subaru','STI\r',NULL),(195,'Mitsubishi','Evo 9\r',NULL),(196,'Mitsubishi','Evo X\r',NULL),(197,'Subaru','WRX\r',NULL),(198,'Subaru','Impreza\r',NULL),(199,'Audi','S4\r',NULL),(200,'Honda','Civic Type R\r',NULL),(201,'Acura','Integra\r',NULL),(202,'Volkswagen ','Jetta\r',NULL),(203,'Ford','Mustang\r',NULL),(204,'Honda','S2000\r',NULL),(205,'BMW','M3 E46\r',NULL),(206,'Nissan','350z\r',NULL),(207,'Infiniti ','G35\r',NULL),(208,'Ford','Mustang GT\r',NULL),(209,'BMW','M3\r',NULL),(210,'Subaru ','BRZ\r',NULL),(211,'Volkswagen ','R32\r',NULL),(212,'Mini','Cooper S\r',NULL),(213,'Chevy','Cobalt SS\r',NULL),(214,'BMW','E46\r',NULL),(215,'Mitsubishi','Evo\r',NULL),(216,'Subaru','STi Hatch\r',NULL),(217,'Honda','civic\r',NULL),(218,'BMW','135i\r',NULL),(219,'Chevy','Corvette C5\r',NULL),(220,'Mazda','RX7\r',NULL),(221,'Nissan','240SX\r',NULL),(222,'Honda','CRX\r',NULL),(223,'Nissan','240SX',NULL);
...
INSERT INTO `classes` VALUES (1,'Street','FWD'),(2,'Street','RWD'),(3,'Street','AWD'),(4,'Street Modified','FWD'),(5,'Street Modified','RWD'),(6,'Street Modified','AWD'),(7,'Track Modified','FWD'),(8,'Track Modified','RWD'),(9,'Track Modified','AWD'),(10,'Unlimited','FWD'),(11,'Unlimited','RWD'),(12,'Unlimited','AWD'),(13,'Spec Fit','FWD');
...
INSERT INTO `drivers` VALUES (1,'Test Driver','Test Driver'),(2,'Test Driver2',NULL),(3,'samel meseljevic',NULL),(4,'Eric DeWitt',NULL),(5,'Charles Miller',NULL),(6,'Max Schrager',NULL),(7,'Bob Dice',NULL),(8,'Jonathan Yu',NULL),(9,'Joshua Halka',NULL),(10,'Blake cameron',NULL),(11,'Kal Fortner',NULL),(12,'Brian Duong',NULL),(13,'Michael Mattila',NULL),(14,'Michael Horn',NULL),(15,'Stephen Barnes',NULL),(16,'Ron Spear',NULL),(17,'Jiyuan Ding',NULL),(18,'Christopher Neuman',NULL),(19,'Corey Claxton',NULL),(20,'aaron kwilas',NULL),(21,'Chris Scheidecker',NULL),(22,'Mark Bucheit',NULL),(23,'Pramoda Rabi',NULL),(24,'George Lee',NULL),(25,'Fiona Lou',NULL),(26,'Graham Gaylord',NULL),(27,'Chad McCurdy',NULL),(28,'Chris Bickford',NULL),(29,'Matthew Kokx',NULL),(30,'Aladin Klicic',NULL),(31,'Benjamin Marouski',NULL),(32,'Jamil Fields',NULL),(33,'Brad Yonkers',NULL),(34,'Anish Ramrakhyani',NULL),(35,'Michael Pagano',NULL),(36,'Matt DeReus',NULL),(37,'Eric Naumann',NULL),(38,'Joshua Orr',NULL),(39,'Jan Raymond Macaspac',NULL),(40,'Shilun Wu',NULL),(41,'Andrew Mishra',NULL),(42,'Michael Puglisi',NULL),(43,'Michael Norman',NULL),(44,'levi brown',NULL),(45,'KYLE MULTZ',NULL),(46,'Tony Fuentes',NULL),(47,'Jess Moeding',NULL),(48,'Dan Lewis',NULL),(49,'Nikolai Delov',NULL),(50,'Chris Ballard',NULL),(51,'Brian Blaine',NULL),(52,'Piotr Tylka',NULL),(53,'Jan Wildner',NULL),(54,'Jordan Bryant',NULL),(55,'Kendall Samuel',NULL),(56,'Greg Maloy',NULL),(57,'charlie ensslin',NULL);
...
CREATE TABLE `events` (
  ...
  PRIMARY KEY (`EventID`),
  KEY `Track_idx` (`Track`),
  CONSTRAINT `Track` FOREIGN KEY (`Track`) REFERENCES `tracks` (`TrackID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `events` VALUES (1,'Test Event',1,'2018-01-31'),(2,'test name',1,'1900-01-01'),(4,'Gridlife Round 5',4,'2017-10-07');
...
CREATE TABLE `laps` (
  ...
  KEY `fk_driver_idx` (`Driver`),
  KEY `fk_track_idx` (`Track`),
  KEY `fk_class_idx` (`Class`),
  KEY `fk_car_idx` (`Car`),
  CONSTRAINT `fk_car` FOREIGN KEY (`Car`) REFERENCES `cars` (`CarID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_class` FOREIGN KEY (`Class`) REFERENCES `classes` (`ClassID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_driver` FOREIGN KEY (`Driver`) REFERENCES `drivers` (`DriverID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_event` FOREIGN KEY (`Event`) REFERENCES `events` (`EventID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_track` FOREIGN KEY (`Track`) REFERENCES `tracks` (`TrackID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `laps` VALUES (1,'1:23.456',1,1,1,1,1),(2,'2:34:567',1,1,1,2,NULL),(3,'3:45:678',1,1,1,3,NULL);
...
INSERT INTO `tracks` VALUES (1,'Test Track'),(4,'Gingerman');
/*!40000 ALTER TABLE `tracks` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'lapdata'
--

--
-- Dumping routines for database 'lapdata'
--
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2018-01-31 23:06:48',NULL),('diagnostics.include_raw','OFF','2018-01-31 23:06:48',NULL),('ps_thread_trx_info.max_length','65535','2018-01-31 23:06:48',NULL),('statement_performance_analyzer.limit','100','2018-01-31 23:06:48',NULL),('statement_performance_analyzer.view',NULL,'2018-01-31 23:06:48',NULL),('statement_truncate_len','64','2018-01-31 23:06:48',NULL);
...
-- Dump completed on 2018-10-09 15:54:34
